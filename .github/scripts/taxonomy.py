...
# ── محور «ماذا تبني؟» (٥ سبتمبر ٢٠٢٦) ────────────────────────────────────
# لماذا وُلد: المجالات الثلاثة عشر تجيب «مَن يخصّه؟» ولا تجيب «ماذا يبني؟».
# فمن أراد أن يبني موقعًا أو تطبيقًا أو يمنتج فيديو لا يجد بابًا إليه، ومادته
# مبعثرة داخل «برمجة وهندسة» — ٤٦٥ بطاقة، أي ثلث اللوحة، فلا تفلتر شيئًا.
#
# والقياس على ١٢٠٦ بطاقة كشف عطلين في المجالات نفسها:
#   · «فيديو وصوت» يخلط شيئين: ٥٣ بطاقة فيديو مقابل ٤١ صوت في مجالٍ واحد،
#     فمن يبحث عن مونتاج يتصفّح تفريغًا صوتيًّا.
#   · «تصميم وواجهات» أكثره ليس واجهات: ٤٥ جرافيك مقابل ٢٠ واجهة — الاسم
#     يقول واجهات والمحتوى جرافيك.
# ولهذا فُصل «فيديو» عن «صوت»، و«جرافيك» عن «واجهة» في هذا المحور.
#
# محورٌ يصفّي فوق المجال لا بديلًا عنه — كـaudience_topic تمامًا:
#   domains      — مَن يخصّه
#   build_target — ماذا يبني
# وقيمة واحدة لكل بطاقة، و«غير محدّد» لما لا يُبنى به شيء (خبر · رأي · بحث).
BUILD_TARGETS = [
    "موقع وصفحة هبوط",     # Next.js · Vercel · قوالب · نشر · صفحات تسويقية
    "تطبيق",               # جوال وسطح مكتب · Flutter · Expo · متاجر التطبيقات
    "واجهة ونظام تصميم",   # مكوّنات · CSS · حركة · Figma · أنظمة تصميم
    "جرافيك وصور",         # توليد صور · شعارات · إنفوجرافيك · بوسترات · تحرير صور
    "فيديو ومونتاج",       # قصّ · رندر · توليد فيديو · B-roll · مؤثّرات
    "صوت",                 # تفريغ · دبلجة · توليد أصوات · بودكاست · موسيقى
    "محتوى وكتابة",        # نصوص · تسويق · SEO · نشرات · عروض تقديمية
    "غير محدّد",           # لا يُبنى به شيء بعينه — خبر أو رأي أو بحث
]
